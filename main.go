...
import (
    ...
    config2 "github.com/shadowsocks/go-shadowsocks2/config"
)
...
func main() {
    ...
    confFile := flag.String("conf", "", "config file")
    ...
    if *confFile != "" {
        jsonConfig, err := config2.ParseConfig(*confFile)
        ...
        flags.UDPTun = jsonConfig.UDPtun
        flags.UDPSocks = jsonConfig.UDPSocks
    }
